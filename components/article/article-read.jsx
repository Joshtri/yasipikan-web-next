...
function ArticleRead({ articleSlug }) {
    ...
    const fetchArticle = async () => {
        try {
            const response = await axios.get(`${process.env.NEXT_PUBLIC_BASE_URL}/api/v1/article/temp/${articleSlug}`);
    ...
    return (
        <>
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <CommentArticle 
                    penulisId={article?.penulisId?._id} 
                    artikelId={article?._id} 
