    ...
    <>
      ...
      >
        ...
        <div className="relative container pl-14 mx-auto px-5 text-white">
          ...
          <h2 className="text-4xl font-bold mb-8 pb-1">
            Temukan Berbagai Buku Berkualitas
          </h2>
          <p className="mb-8">
            Kami menyediakan berbagai pilihan buku yang dapat Anda beli secara online.
            Mulai dari buku pelajaran, novel, hingga buku referensi akademik tersedia di toko kami.
