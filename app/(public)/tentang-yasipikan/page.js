export const metadata = {
    ...
    description: "Menyatukan kebaikan, membangun masa depan yang lebih cerah bersama YaSiPiKan.",
    openGraph: {
        title: "Tentang Yayasan Sirih Pinang Kebaikan",
        description: "Yayasan Sirih Pinang Kebaikan bergerak dalam bidang kemanusiaan, percetakan, pendidikan, dan religi.",
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="p-6 bg-white text-black">
                            ...
                            <p className="mb-4 leading-relaxed">
                                Yayasan Sirih Pinang Kebaikan, disingkat YaSiPiKan, adalah sebuah
                                yayasan yang bergerak di bidang kemanusiaan, percetakan,
                                pendidikan, dan religi. Kami bertujuan untuk membangun gereja
                                dan negara dengan cara menebarkan kebaikan Allah melalui berbagai
                                program yang inovatif.
                            </p>
                            <p className="leading-relaxed">
                                Didirikan di Kupang – Ibukota Provinsi Nusa Tenggara Timur pada tanggal{" "}
                                <strong>22 Desember 2023</strong>, laju perjalanan kebaikan merupakan
                                cerminan komitmen dan kerjasama.
                            </p>
                        </div>
                    </div>
                </Card>
                    ...
                    <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <Card className="shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-800">
                                    Kami menawarkan layanan penerbitan ISBN serta percetakan buku
                        ...
                        <Card className="shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-800">
                                    Kami membantu jemaat dalam pengembangan ekonomi serta pemberdayaan
                        ...
                        <Card className="shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-800">
                                    Kami menyelenggarakan kuliah umum dan kursus musim panas untuk menambah
                    ...
                    <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <Card className="shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-800">
                                    Kami bekerja sama dengan para pendeta dan penulis untuk menuangkan
                                    karya dan pemikiran dalam bentuk tulisan.
                                </p>
                            </div>
                        </Card>
                        ...
                        <Card className="shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-800">
                                    Kami membantu gereja-gereja di daerah 3T untuk meningkatkan SDM dan
                                    ekonomi jemaat.
                                </p>
                            </div>
                        </Card>
                        ...
                        <Card className="shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-800">
                                    Kami memberikan pemberdayaan berkelanjutan dalam bentuk materi dan bantuan
                                    sosial.
                                </p>
                            </div>
                        </Card>
                        ...
                        <Card className="shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-800">
                                    Kami menyediakan Wi-Fi Orbit bagi jemaat yang tinggal di daerah dengan
                                    akses jaringan yang sulit.
                                </p>
                            </div>
                        </Card>
                        ...
                        <Card className="shadow-lg rounded-lg hover:shadow-2xl transition-shadow">
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-gray-800">
                                    Kami memberikan materi dari para ahli di bidangnya masing-masing untuk
                                    menambah pengetahuan jemaat.
                                </p>
                            </div>
                        </Card>
                    </div>
